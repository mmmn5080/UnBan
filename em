...
payload:
  ...
  - DOMAIN-SUFFIX,nano.jmsuper.com
...
# Emby Hub & EdNovascloud
  - DOMAIN-SUFFIX,ednovas.org

##### F #####

# Facmata
  - DOMAIN-SUFFIX,cinema.facmata.net

# 飞跃彩虹
  - DOMAIN-SUFFIX,7777777.buzz
  - DOMAIN-SUFFIX,581658.best
...
# HXD(Porn)
  - DOMAIN-SUFFIX,hxd.as174.com
  - DOMAIN-SUFFIX,bili.rip
  - DOMAIN-SUFFIX,nvidia.rip

# 红尘(Porn)
  - DOMAIN-SUFFIX,cc.semby.ink
  - DOMAIN-SUFFIX,happyav.eu.org

# 黑丝(Porn)
  - DOMAIN-SUFFIX,i109.com

# 花云
  - DOMAIN-SUFFIX,emby.flowercloud

# 黑猫影视EMBY
  - DOMAIN-SUFFIX,uuuoo.cc
  - DOMAIN-SUFFIX,emby.bid
  - DOMAIN-SUFFIX,emby.date
  - DOMAIN-SUFFIX,emby.loan
  - DOMAIN-SUFFIX,emby.trade

# HKA(私服自建)
  - DOMAIN-SUFFIX,252798.xyz
...
# Lyrebird(琴鸟)
  - DOMAIN-SUFFIX,lyrebirdemby.com
...
# Land Emby
  - DOMAIN-SUFFIX,emby.lcloud.wiki
...
# Magpie(喜鹊)
  ...
  - DOMAIN-SUFFIX,magpiecdn.tech

# Misty Emby
  - DOMAIN-SUFFIX,misty.ltd
  - DOMAIN-SUFFIX,em.ssky.me
...
# ntRRR
  - DOMAIN-SUFFIX,ntrrr.am.sb
  - DOMAIN-SUFFIX,stream.ntrrr.top
  - DOMAIN-SUFFIX,stream.synn.cc
...
# Nebula
  - DOMAIN-SUFFIX,nebula-emby.com

# Netcup
  - DOMAIN-SUFFIX,404.sb
...
# Otaku
  - DOMAIN-SUFFIX,emby.ok.edu.hk
  - DOMAIN-SUFFIX,emby.neko.edu.rs
  - DOMAIN-SUFFIX,emby.otakudrive.life
  - DOMAIN-SUFFIX,emby2.otakudrive.life

# OUO
  - DOMAIN-SUFFIX,ouonet.org
...
# PornEmby
  ...
  - DOMAIN-SUFFIX,ii00.cc

# PornEmby(网抑云)
  - DOMAIN,195.201.86.86
...
# 普拉斯影业
  ...
  - DOMAIN-SUFFIX,emby-sg.plusmedia.site
...
# 忍者云Emby
  - DOMAIN-SUFFIX,emby1.medi4.org
  - DOMAIN-SUFFIX,emby2.medi4.org

# Robo
  - DOMAIN-SUFFIX,91ai.de
...
# 私房菜Emby
  - DOMAIN,notnetflix.cos.cat
  - DOMAIN,cminf.sfcat.link
  - DOMAIN,cuinf.sfcat.link
...
# 太空人
  - DOMAIN-SUFFIX,tkremby.xyz

# Texon
  - DOMAIN-SUFFIX,texon.fans
...
# ZDZ(Terminus)
  ...
  - DOMAIN-SUFFIX,pub1cf.emby.wtf
  - DOMAIN-SUFFIX,pub2cf.emby.wtf
  - DOMAIN-SUFFIX,pub3cf.emby.wtf
